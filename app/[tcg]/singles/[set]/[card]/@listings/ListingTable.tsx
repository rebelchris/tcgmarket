...
export default function ListingTable({ listings, userListings, otherListings, tcg }: { listings: any[], userListings: any[], otherListings: any[], tcg: string }) {
  return (  
                  ...
                  >
                    ...
                    <td className="px-3 py-2 md:hidden text-center">
                      <span
                        ...
                        data-tooltip-id={`desc-${listing.id}`}
                        data-tooltip-content={listing.notes ?? '-'}
                      >
