        ...
        <Container size="1">
            <Box px={{
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to TCGmarket, accessible from <a
                            href="https://tcgmarket.co.za" rel="external nofollow noopener"
                            target="_blank">https://tcgmarket.co.za</a></p>
                    </li>
                    <li>
